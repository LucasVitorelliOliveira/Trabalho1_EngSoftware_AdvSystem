...
namespace AdvSystem.Controllers
{
    ...
    public class AgendaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Data,Descricao")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Data,Descricao")] Agenda agenda)
        {
            if (id != agenda.Id)
            {
                return NotFound();
